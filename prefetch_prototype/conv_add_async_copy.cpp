...
int main(int argc, char * argv[])
{
    ...
    int* C_data;
    HIP_CHECK(hipHostMalloc(&C_data, input_size * sizeof(int)));
    std::copy(C_vec.begin(), C_vec.end(), C_data);
    ...
    HIP_CHECK(hipMemcpyAsync(gpu_C, C_data, bytes_C, hipMemcpyHostToDevice, memory_stream));
